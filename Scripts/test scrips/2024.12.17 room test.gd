...
func _process(delta: float) -> void:
	...
	json_files_info_dict["Room 1"] = return_json_info_dict(ROOM_1_PATH)
	json_files_info_dict["Room 2"] = return_json_info_dict(ROOM_2_PATH)
	json_files_info_dict["Room 3"] = return_json_info_dict(ROOM_3_PATH)
	json_files_info_dict["Room 4"] = return_json_info_dict(ROOM_4_PATH)
	json_files_info_dict["Room 5"] = return_json_info_dict(ROOM_5_PATH)
	json_files_info_dict["Room 6"] = return_json_info_dict(ROOM_6_PATH)
	json_files_info_dict["Room 7"] = return_json_info_dict(ROOM_7_PATH)
	
	var room_dict = {}
	var counter = 0
	if button.is_pressed():
		room_dict["room " + str(counter)] = place_compatible_room(2, json_files_info_dict, room_dict)
		counter += 1
...
func _ready() -> void:
	button.button_up.connect(delete_later)
	...
	#for key in json_files_info_dict:
		#print(json_files_info_dict[key]["num_paths"])
		

	var rooms_dict = {}
	rooms_dict["room 1"] = place_compatible_room(2, json_files_info_dict, rooms_dict)
	rooms_dict["room 2"] = place_compatible_room(2, json_files_info_dict, rooms_dict)
	rooms_dict["room 3"] = place_compatible_room(1, json_files_info_dict, rooms_dict)
	rooms_dict["room 4"] = place_compatible_room(1, json_files_info_dict, rooms_dict)
	...
	'''
	print(json_files_info_dict["Room 1"]["available_paths"])
	print(json_files_info_dict["Room 1"]["available_paths"].has(get_inverse_str_direction("right")))
	print(get_inverse_str_direction("right"))
	'''
...
func delete_later():
	...
	json_files_info_dict["Room 6"] = return_json_info_dict(ROOM_6_PATH)
	json_files_info_dict["Room 7"] = return_json_info_dict(ROOM_7_PATH)
	json_files_info_dict["Room 8"] = return_json_info_dict(ROOM_8_PATH)
	json_files_info_dict["Room 9"] = return_json_info_dict(ROOM_9_PATH)
	json_files_info_dict["Room 10"] = return_json_info_dict(ROOM_10_PATH)
	json_files_info_dict["Room 11"] = return_json_info_dict(ROOM_11_PATH)
	json_files_info_dict["Room 12"] = return_json_info_dict(ROOM_12_PATH)
	json_files_info_dict["Room 13"] = return_json_info_dict(ROOM_13_PATH)
	json_files_info_dict["Room 14"] = return_json_info_dict(ROOM_14_PATH)
	json_files_info_dict["Room 15"] = return_json_info_dict(ROOM_15_PATH)
	'''
